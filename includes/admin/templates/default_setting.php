...
<div class="wrap click-dashboard">
	<h1 class="wp-heading-inline defaultsetingtitle">Default Settings</h1>
</div>
<form method="post" action="" class="defaultsetingform">
	<table class="form-table wpam_table wpam_basic">
		<tbody>
			...
			<tr>
				<td class="lasttd">
					<input type="hidden" name="wpam_action" value="save_option">
